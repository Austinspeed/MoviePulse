    ...
    <div>
        {backdropUrl &&(
            <div className='relative h-[40vh] w-full md:h-[50vh] lg:h-[60vh] overflow-hidden'>
                <div className='absolute inset-0 bg-cover bg-center opacity-50' style={{backgroundImage: `url(${backdropUrl})`}}></div>
                <div className='absolute inset-0 bg-gradient-to-t from-gray-900/90 dark:from-black dark:via-black/90'></div>
            </div>
        )}
        <div className='container mx-auto px-4 py-8 relative z-10 -mt-20 md:-mt-32'>
            <div className='flex flex-col md:flex-row gap-8'>
                ...
                <div className='w-full md:w-2/3 lg:w-3/4'>
                    <h1 className='text-3xl md:text-4xl font-bold md:text-white text-gray-800 dark:text-gray-400 ml-2'>
                        {movie.title}
                        <span>({new Date(movie.release_date).getFullYear()})</span>
                    </h1>

                    {/* Overview  */}
                    <div className='mb-8 mt-8 px-2 md:mt-24'>
